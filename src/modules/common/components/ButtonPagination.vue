<template>
    <div class="flex justify-center py-10 bg-gray-100 space-x-3">
        ...
        <button :disabled="page === 1" @click="$router.push({ query: { page: page - 1 } })"
            class="flex items-center space-x-1.5 rounded-lg px-4 py-1 text-white bg-blue-500 disabled:bg-gray-400 hover:bg-blue-700 active:translate-y-0.5 transition-all ">
            <ArrowLeftIcon />
